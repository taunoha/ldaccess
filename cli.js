...
program
    .version('1.0.0')
    .description('Use this programm to restrict access to web folder using htpasswd.')
...
// Check for files
//
if( file.fileExists(file.getCurrentDirectoryPath() + '/.htaccess') || file.fileExists(file.getCurrentDirectoryPath() + '/.htpasswd') ) {
